...
import FABDMetaResponse from '@app/common/pagination/interfaces/meta.interfaces';
...
export class TodoRepository extends Repository<Todo> {
	 ...
	 * @returns 
	 */
	async safeDeleteById(id: string, deleted_by: string, deleted_name: string): Promise<Todo>{
